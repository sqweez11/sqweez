...
<html lang="en-US">
<head>
<title>Sqweez - будущее.</title>
<meta charset="utf-8">
<meta name="description" content="Sqweez - это не популярный проект по разроботке стороннего ПО, читов, вирусов и много другой чертовщины. За этим проектом стоят не просто программисты а лучшие в своем деле кодеры,  люди которые посвятили этому жизнь.">
<meta name="keywords" content="cheats, software, debugger, windows, linux, macos, freebsd, open source">
<meta name="google-site-verification" content="cO1o6sx54cvKxhbnYsABWtl4sYFj9uVKV0DxLKZkWv8"/>
<?php include 'lib/module/sys-meta.php';?>
<meta property="og:title" content="Sqweez - Будущиe" />
<meta property="og:description" content="Sqweez - это не популярный проект по разроботке стороннего ПО, читов, вирусов и много другой чертовщины. За этим проектом стоят не просто программисты а лучшие в своем деле кодеры,  люди которые посвятили этому жизнь." />
...
<meta property="og:site_name" content="Sqweez" />
<meta name="twitter:title" content="Sqweez - Будущиe">
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Sqweez - будь с нами<br>
							 ты обязательно будешь удивлен будущим!</h1>
						</div>
						 <div class='landing-tx2-heading'> 
							<p>
								 Sqweez - это не популярный проект по разроботке стороннего ПО, читов, вирусов и много другой чертовщины. За этим проектом стоят не просто программисты а лучшие в своем деле кодеры,  люди которые посвятили этому жизнь.
							</p>
							<!-- <div class='landing-btn-container'> 
								<div class="build-btn-button"> 
									<div class="build-ico-button"> 
										<div class="build-ico-os">
											<img alt="Windows" src="img/icons/os/windows.png" style='height: 100%; width: 100%; object-fit: 
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							<div class="discord-tx1-mantra darkmode-txt">
								<h2>Наш Discord сервер</h2>
								<div class="landing-con-divider">
								</div>
							</div>
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
								Мы используем Discord для общение с единомышленниками, там вы можете связаться с разработчиками крупных проектов, попросить совета, купить нашу продукцию, обмениваться знаниями с другими людьми. Также будем помогать вам с вашими проблемами какими-бы они не были.
								</p>
							</div>
							<a href="https://discord.gg/Sg2NFcptDW" target="_blank">
					...
					<div class="patreon-con-mantra"> 
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							...
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
									Это наш Telegram-бот, который модерируют наши модераторы. Вы можете оставить там любой интересующий вас вопрос или проблему, и они обязательно быстро ответят и помогут. Если у вас возникла проблема с купленным товаром, обращайтесь туда же.
								</p>
							</div>
