	...
	<div class="banner-con-container darkmode-header">
		...
		<div class='banner-con-title fade-up-onstart'>
			...
			<div class='banner-tx2-title fade-up-onstart'>
				<p>
					Все товары которые есть на данный момент у нас в магазине.
					<br>
					</p>
					<h2>1. Loader C++ - идеальный лоадер который 100% защищает любые продакты, а также выполняет функцию создание ключей и многое другое.</h2>
					<a href="https://discord.gg/Sg2NFcptDW" target="_blank">
				<span>Видео про лоадер *Кликабельно* <span>
				</p>
			</div>
		</div>
	</div>
