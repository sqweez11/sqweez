					...
					<div class="video-con-container">
						...
						<div class='video-con-right'>
							<div class="video-tx1-description darkmode-txt scale-content-txt-4">
								...
								<h2>Личный Loader написанный на C++ для безопастности ваших читов и любых других продуктов. </h2>
								<h3>Данный лоадер обладает множеством функций, пройдемся по главным из них. Защита HWID, защита IP, создание любого количества ключей доступа к программе на любой срок, красивая и понятная настройка Лоадера, доступ к IP и HWID того человека кто использовал ваш Лоадер и многое другое.</h3>
							</div>
						</div>
					</div>
				</div>
